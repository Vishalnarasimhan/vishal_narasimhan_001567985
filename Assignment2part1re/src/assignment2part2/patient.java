...
public class patient {
    ...
    private ArrayList<vitalsigns> Vitalhistory;
    public ArrayList<patient> patienthistory;
    
    boolean standard = false;
    
    public patient(int patientId, String First_Name,String Second_name,float Age,vitalsigns vitalsign){
    ...
    public String toString() {
        return "patient{" + "patientId=" + patientId + ", First_Name=" + First_Name + ", Second_name=" + Second_name + ", Age=" + Age + '}';
    }
    ...
    public ArrayList<vitalsigns> getVitalhistory() {
        return Vitalhistory;
    }

    public void setVitalhistory(ArrayList<vitalsigns> Vitalhistory) {
    ...
    public void addvitals (vitalsigns vital){
            if(vitalsign == null){
    this.vitalsign = vital;
    }
    else{
    this.Vitalhistory.add(vitalsign);
    this.vitalsign = vital;
}        
    }          
